...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Cargo cargo5 = new Cargo( CurrentDate.currentDate, true, "Mehmet Aydın", "/dialogButtons/woman.png","Cargo5",CityStorage.getCityById(11));
        Cargo cargo6 = new Cargo( CurrentDate.currentDate, true, "Semih Bekdaş", "/dialogButtons/man.png","Cargo6",CityStorage.getCityById(54));
        Cargo cargo7 = new Cargo( CurrentDate.currentDate, true, "Semih Bekdaş", "/dialogButtons/woman.png","Cargo7",CityStorage.getCityById(22));
        Cargo cargo8 = new Cargo( CurrentDate.currentDate, true, "Semih Bekdaş", "/dialogButtons/man.png","Cargo8",CityStorage.getCityById(48));
        Cargo cargo9 = new Cargo( CurrentDate.currentDate, true, "Semih Bekdaş", "/dialogButtons/woman.png","Cargo9",CityStorage.getCityById(16));
